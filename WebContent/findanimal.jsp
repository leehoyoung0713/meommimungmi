...
<title>유기동물찾기</title>
  <link rel="stylesheet" href="./header.css">
    <link rel="stylesheet" href="./findanimal.css">
        ...
        <main>
            <div id="store-app" data-base="/web/store/campaign/">
                <div class="StoreCollectionVisual_container__kPoxZ">
                    <div class="StoreCollectionVisual_visual__dNWlZ" style="background-image:url('http://www.petpaper.co.kr/news/photo/202008/1056_931_1532.jpg');">
                    ...
                    <div class="StoreCollectionVisual_text__3J0Gz">
                        <div class="StoreCollectionVisual_titleBox__2fOPp">
                            <p class="StoreCollectionVisual_title__uPhCG">유기동물 찾기</p>
                        ...
                        <p class="StoreCollectionVisual_description__1iWKX">
                            ...
                            <br>
                            <br>
                            현재 입양되지 못한 채 주인을 기다리는 유기견들이 있습니다.😭
                            <br>
                            <br>
                            🎁 와쑈 전용 10% 쿠폰 혜택
                            <br>
                            유기견 입양시, 반려동물과 함께 휴가를 즐길 수 있는 무료 숙박권 제공
                            <br>
                            <br>
                            * 쿠폰 다운로드 & 사용 기간 : 9/28(수)~10/4(화)
                            <br>
                            * 마이페이지>쿠폰존에서 다운로드 받을 수 있어요!
                        </p>
                    </div>
                </div>
